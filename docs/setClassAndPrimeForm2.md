...
_Analytically_, the concept of set class is useful because it can show coherence in a composition. Bartók's "Subject and Reflection," for example, uses the (02357) set class nearly exclusively—though it appears in many transpositions and inversions.
...
![](Graphics/postTonal/trichordsAndNonachords.png)

Prime form for each set class is show in parenthesis. The "Forte Number" (3-1, 9-1, etc.), often adjacent to the prime form, was given to each set class by the famous music theorist Allen Forte, who was one of the first to describe the set class list.
...
<sub> Note: broken links have been removed and not replaced. </sub>
